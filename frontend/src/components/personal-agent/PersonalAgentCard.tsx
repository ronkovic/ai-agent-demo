import { PersonalAgentResponse } from "@/lib/api-client/types.gen";
import { MoreVertical, Edit, Trash, Bot } from "lucide-react";
import { Button } from "@/components/ui/Button";
import { cn } from "@/lib/utils";
import { useState } from "react";

interface PersonalAgentCardProps {
  agent: PersonalAgentResponse;
  onClick?: () => void;
  onEdit?: () => void;
  onDelete?: () => void;
  className?: string;
...
export function PersonalAgentCard({
  agent,
  onClick,
  onEdit,
  onDelete,
  className,
}: PersonalAgentCardProps) {
